<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Klasifikasi Buku</li>
    </ol>
  </div><!--/.row-->

  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Tambah Klasifikasi Buku</h1>
    </div>
  </div><!--/.row-->
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="col-md-6 col-md-offset-3">
            <form action="<?= base_url('admin/klasifikasi_buku/tambah') ?>" method="POST">
              <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>">
              <input type="hidden" name="id_klas" id="id_klas" value="<?= $uuid ?>">
              <div class="form-group">
                <label for="kode_klas">Kode Klasifikasi</label>
                <input name="kode_klas" id="kode_klas" type="text" class="form-control" readonly="" value="<?= $kodeklas ?>">
              </div>
              <div class="form-group <?= form_error('nama_klas') ? 'has-error' : null ?>">
                ...
                <input name="nama_klas" id="nama_klas" type="text" class="form-control" autofocus="" value="<?= set_value('nama_klas') ?>">
