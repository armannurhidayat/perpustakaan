<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Lokasi Buku</li>
    </ol>
  </div><!--/.row-->

  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Tambah Lokasi Buku</h1>
    </div>
  </div><!--/.row-->
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="col-md-6 col-md-offset-3">
            <form action="<?= base_url('admin/peta_lokasi/tambah') ?>" method="POST">
              <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>">
              <input type="hidden" name="id_lokasi" id="id_lokasi" value="<?= $uuid ?>">
              <div class="form-group <?= form_error('kode_lokasi') ? 'has-error' : null ?>">
                ...
                <input name="kode_lokasi" id="kode_lokasi" type="text" class="form-control" autofocus="" value="<?= set_value('kode_lokasi') ?>">
