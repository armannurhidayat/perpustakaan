<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Tambah Jenis Bacaan</li>
    </ol>
  </div><!--/.row-->

  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Tambah Jenis Bacaan</h1>
    </div>
  </div><!--/.row-->
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="col-md-6 col-md-offset-3">
            <form action="<?= base_url('admin/jenis_bacaan/tambah') ?>" method="POST">
              <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>">
              <input type="hidden" name="id_jenis" id="id_jenis" value="<?= $uuid ?>">
              <div class="form-group">
                <label for="kode_jenis">Kode Jenis</label>
                <input name="kode_jenis" id="kode_jenis" type="text" class="form-control" readonly="" value="<?= $kodebacaan ?>">
              </div>
              <div class="form-group <?= form_error('nama_jenis') ? 'has-error' : null ?>">
                ...
                <input name="nama_jenis" id="nama_jenis" type="text" class="form-control" autofocus="" value="<?= set_value('nama_jenis') ?>">
                <small class="text-success"><?= form_error('nama_jenis') ?></small>
              </div>
